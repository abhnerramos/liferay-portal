...
const fdsCellRenderer = ({ value }) => {
    ...
    external_react_dom_namespaceObject["default"].render(external_react_namespaceObject["default"].createElement(external_react_namespaceObject["default"].Fragment, null, value == 'Green' ? '🍏' : value), element);
    return element;
};
